...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/musdcoin-project/musdcoin>";
    const std::string URL_WEBSITE = "<https://musdcoin.org>";
