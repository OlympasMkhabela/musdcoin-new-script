...
const char * const BITCOIN_CONF_FILENAME = "musdcoin.conf";
const char * const BITCOIN_PID_FILENAME = "musdcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Musdcoin";
#else
    // Unix
