...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s musdcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  musdcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded musdcoin transaction") + "\n" +
              "  musdcoin-tx [options] -create [commands]   " + _("Create hex-encoded musdcoin transaction") + "\n" +
              "\n";
