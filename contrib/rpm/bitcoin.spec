...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 59776
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 59777
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 59776
	%{_sbindir}/semanage port -d -p tcp 59777
	for selinuxvariant in %{selinux_variants}; do
